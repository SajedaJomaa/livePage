let currentPage=1,isFetching=!1,hasMore=!0,lastImage;const root=document.querySelector(".fb_body");async function fetchData(){if(!isFetching&&hasMore){isFetching=!0;try{var e=await(await fetch(`https://picsum.photos/v2/list?page=${currentPage}&limit=10`)).json();console.log(e),0===e.length?hasMore=!1:(e.forEach(e=>{var t=document.createElement("div");t.classList.add("add_post_scrolling"),t.innerHTML=`
    ...
    `,document.body.appendChild(t),t.querySelector(".close").onclick=function(){t.style.display="none"},t.onclick=function(e){e.target===t&&(t.style.display="none")}}function showImagesInModal(e){var t=document.querySelector(".image-modal");let a=t.querySelector(".image-gallery");a.innerHTML="",e.forEach(e=>{var t=document.createElement("img");t.src=e,a.appendChild(t)}),t.style.display="block"}function displayPost(a){var e=document.createElement("div");e.classList.add("add_post_container"),e.style.display="block",e.dataset.id=a.id;let o=`
        <div class="post_row">
            <div class="user_profile">
        ...
        <p>${a.content}</p>
    `;0<a.images.length&&(o+='<div class="post_image_container grid_image_container">',a.images.forEach((e,t)=>{t<3?o+=`<img class="post_img" src="${e}" alt="postImage">`:3===t&&(o+=`
